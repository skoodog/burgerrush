...
const BONES: readonly BoneDef[] = [
  ...
  { name: 'toque', parent: 'head', x: -0.5, y: -9, rotation: 0, length: 12 },
  { name: 'toqueTip', parent: 'toque', x: 0, y: -6, rotation: 0, length: 6 },
  { name: 'hairTail', parent: 'head', x: -5, y: -2, rotation: 0, length: 10 },

  { name: 'scarf', parent: 'chest', x: 1, y: -3, rotation: 0, length: 6 },
